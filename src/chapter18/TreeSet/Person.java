...
class PersonCompare implements Comparator<Person> {
	...
	@Override
	public int compare(Person o1, Person o2) { 		// '매개변수로 두 비교값이 들어왔을 때 어떤 기준으로 할래?' 라고 묻는거
...
class ArrayListTest {
	...
	TreeSet<Person> personList = new TreeSet<Person>(new PersonCompare()); // Compare 매개변수값 넣기
	Professor pro;
	Student stu;
